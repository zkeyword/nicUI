            ...
            c = {
                    ...
                    eventFn: function(){
                        ...
                        target
                            ...
                            .on('click', '.l-tree-node', function(e){
                                ...
                                ui.onselectstart(that);
                                    
                                if( tool.isFunction(p.onClick) && !p.check ){
                                    clearTimeout(time);
                            ...
                            .on('contextmenu', '.l-tree-node', function(e){
                                if( tool.isFunction(p.onRightClick) ){
                                    var that = $(e.currentTarget),
                                        data = itemData(that);
                            ...
                            .on('mouseover', '.l-tree-node', function(e){
                                if( tool.isFunction(p.onMouseOver) ){
                                    var that = $(e.currentTarget),
                                        data = itemData(that);
                            ...
                            .on('mouseout', '.l-tree-node', function(e){
                                if( tool.isFunction(p.onMouseOut) ){
                                    var that = $(e.currentTarget),
                                        data = itemData(that);
                    ...
                    */
                    init: function(o){
                        ...
                        c.run();
                        if( p.data && tool.isFunction(p.onLoad) ){
                            p.onLoad(p.data, _cache.selected);
                        }
                        return g;
                    }
